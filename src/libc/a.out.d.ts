...
declare namespace RuntimeExports {
    ...
    namespace JSEvents {
        ...
        function deferCall(targetFunction: any, precedence: any, argsList: any): void;
        ...
        function getTargetThreadForEventCallback(targetThread: any): any;
...
interface WasmModule {
  _saveImage(): void;
  _generateRenderFractal(_0: number, _1: number, _2: number, _3: number, _4: number, _5: number, _6: number, _7: number): void;
  _generateSaveFractal(_0: number, _1: number, _2: number, _3: number, _4: number, _5: number, _6: number, _7: number, _8: number): void;
